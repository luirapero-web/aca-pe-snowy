...
‎
‎const PLAZAS = [
‎  {id:1, distrito:"JESUS MARIA", tag:"DESTACADA", estado:"VERIFICADO", live:true,
‎nombre:"CLASIFICATORIA 08", 
‎fecha:"DOM 13 SET", fechaISO:"2026-09-13", 
‎hora:"4:30PM", lugar:"CAMPO DE MARTE - ENTRADA AV. SALAVERRY", 
‎tipo:"PLAZA", visitas:126, 
‎img: "/plazas/cdmacape.webp", 
‎data:{LUGAR:"CAMPO DE MARTE - ENTRADA AV. SALAVERRY", 
‎HORA:"4:30 PM", 
‎FECHA:"DOMINGO 13 DE SETIEMBRE", 
‎INSCRIPCION:"s/5 - s/7 filtros", 
‎HOST:"NATAN - ZK", 
‎JURADOS:"LOA<br/>KEDRIC<br/> BEEF", 
‎PREMIO:"100 SOLES<br/>CUPO A NACIONAL<br/>S/400 RUMBO A LA INTER"}},
‎
‎  {id:2, distrito:"CERCADO DE LIMA", tag:"", estado:"VERIFICADO", live:true, 
‎nombre:"RAPBUCA", 
‎fecha:"LUN 14 SET", fechaISO:"2026-09-14", 
‎hora:"4PM", 
‎host:"Zismo", 
‎lugar:"PARQUE JUANA ALARCO DE DAMMERT", 
‎tipo:"OPEN", visitas:89, 
‎img:"/plazas/rapbuca.webp", 
‎data:{LUGAR:"Parque Juana Alarco de Dammert", 
‎HORA:"6:00 PM", 
‎FECHA:"Lunes 14 Setiembre", INSCRIPCION:"GRATIS", 
‎HOST:"Zismo", 
‎JURADOS:"Sitho <br/> Sharp <br/>You", 
‎PREMIO:"s/80<br/> 1 corte cabello x Yisus Lion <br/>1 producción musical x Flow La Mata<br/>1 pack de snack x Wayquis"}},
‎
‎]
‎
