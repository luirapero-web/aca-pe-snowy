...
const PLAZAS = [
  ...
  {id:2, distrito:"CERCADO DE LIMA", tag:"", estado:"VERIFICADO", live:true, nombre:"RAPBUCA", fecha:"LUN 14 SET", fechaISO:"2026-09-14", hora:"4PM", host:"Zismo", lugar:"PARQUE JUANA ALARCO DE DAMMERT", tipo:"OPEN", visitas:89, img:"/plazas/rapbuca.webp", data:{LUGAR:"Parque Juana Alarco de Dammert", HORA:"6:00 PM", FECHA:"Lunes 14 Setiembre", INSCRIPCION:"GRATIS", HOST:"Zismo", JURADOS:"Situó - Sharp - You", PREMIO:"s/80<br/> 1 corte de cabello"}},
